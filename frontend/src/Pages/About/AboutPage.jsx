    ...
    return (
        <div>
            <div className="container flex justify-center mx-auto pt-16">
                <div>
                    {/*<p className="text-ultramarine-950 text-lg text-center font-bold pb-3">Our Team</p>*/}
                    <h1 className="xl:text-4xl text-3xl text-center text-ultramarine-900-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">The
                        Talented People Behind the <span
                            className="tracking-tighter font-extrabold text-ultramarine-950 text-center">
                        bluemonster.
                    </span></h1>
                </div>
            </div>
                ...
                <div className="container mx-auto">
                    <div className="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                            <div className="rounded-xl overflow-hidden shadow-xl bg-ultramarine-100">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Sindu Aditya Janadi</div>
                                    <p className="text-gray-800 text-sm text-center">Frontend Developer</p>
                                    <p className="text-center text-gray-600 text-base pt-3 font-normal">Sindu bekerja membenarkan tampilan frontend agar berjalan dengan semestinya da sesuai UI </p>
